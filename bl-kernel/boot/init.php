...
// Version
define('HEADLESS_PHP_VERSION',        '3.16.2');
define('HEADLESS_PHP_CODENAME',       'Valencia');
define('HEADLESS_PHP_RELEASE_DATE',   '2024-08-23');
define('HEADLESS_PHP_BUILD',          '20240806');
...
// Left empty if you want to detect the base URL.
$base = '';
