...
<ul class="nav flex-column pt-4">
    ...
    <li class="nav-item mb-4" style="margin-left: -4px;">
        <img src="<?php echo HTML_PATH_CORE_IMG ?>favicon.png" width="20" height="20" alt="Headless.PHP-logo"><span class="ml-2 align-middle"><?php echo (defined('HEADLESS_PHP_PRO')) ? 'Headless.PHP PRO' : 'Headless.PHP' ?></span>
    </li>
