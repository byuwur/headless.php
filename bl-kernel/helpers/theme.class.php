...
class Theme
{
    ...
    // Ex. https://example.com/headless.php/ the method returns https://example.com/headless.php/
    ...
    // Ex. https://example.com/headless.php/admin/ the method returns https://example.com/headless.php/admin/
    ...
    public static function css($files, $base = DOMAIN_THEME)
    {
        ...
        foreach ($files as $file) {
            $links .= '<link rel="stylesheet" type="text/css" href="' . $base . $file . '?version=' . HEADLESS_PHP_VERSION . '">' . PHP_EOL;
        }
    ...
    public static function javascript($files, $base = DOMAIN_THEME, $attributes = '')
    {
        ...
        $scripts = '';
        foreach ($files as $file) {
            $scripts .= '<script ' . $attributes . ' src="' . $base . $file . '?version=' . HEADLESS_PHP_VERSION . '"></script>' . PHP_EOL;
        }
    ...
    {
        return '<script src="' . DOMAIN_CORE_JS . 'jquery.min.js?version=' . HEADLESS_PHP_VERSION . '"></script>' . PHP_EOL;
    }

    public static function jsBootstrap($attributes = '')
    {
        return '<script ' . $attributes . ' src="' . DOMAIN_CORE_JS . 'bootstrap.bundle.min.js?version=' . HEADLESS_PHP_VERSION . '"></script>' . PHP_EOL;
    }

    public static function cssBootstrap()
    {
        return '<link rel="stylesheet" type="text/css" href="' . DOMAIN_CORE_CSS . 'bootstrap.min.css?version=' . HEADLESS_PHP_VERSION . '">' . PHP_EOL;
    }

    public static function cssBootstrapIcons()
    {
        // https://icons.getbootstrap.com/
        return '<link rel="stylesheet" type="text/css" href="' . DOMAIN_CORE_CSS . 'bootstrap-icons/bootstrap-icons.css?version=' . HEADLESS_PHP_VERSION . '">' . PHP_EOL;
    }

    public static function cssLineAwesome()
    {
        return '<link rel="stylesheet" type="text/css" href="' . DOMAIN_CORE_CSS . 'line-awesome/css/line-awesome-font-awesome.min.css?version=' . HEADLESS_PHP_VERSION . '">' . PHP_EOL;
    }

    public static function jsSortable($attributes = '')
    {
        // https://github.com/psfpro/bootstrap-html5sortable
        return '<script ' . $attributes . ' src="' . DOMAIN_CORE_JS . 'jquery.sortable.min.js?version=' . HEADLESS_PHP_VERSION . '"></script>' . PHP_EOL;
    }
}
