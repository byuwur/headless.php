...
// Base URL
// Change the base URL or leave it empty if you want to try to detect the base URL.
$base = '';
...
function install($adminPassword, $timezone)
{
    ...
    $dataHead = "<?php defined('HEADLESS_PHP') or die('Headless.PHP'); ?>" . PHP_EOL;
    ...
    // If Headless.PHP is not installed inside a folder, the URL doesn't need finish with /
    ...
    $data = array(
        'title' => 'Headless.PHP',
        'slogan' => $L->get('welcome-to-headless'),
        'description' => $L->get('congratulations-you-have-successfully-installed-your-headless'),
        ...
        'orderBy' => 'date',
        'currentBuild' => '0',
        'twitter' => 'https://twitter.com/byuwur',
        'facebook' => 'https://facebook.com/byuwur',
        'codepen' => 'https://codepen.io/byuwur',
        'github' => 'https://github.com/byuwur',
        'instagram' => 'https://instagram.com/byuwur',
        'gitlab' => '',
        'linkedin' => 'https://linkedin.com/in/atrujillomateus',
        'xing' => '',
        'telegram' => '',
        'dateFormat' => 'F j, Y',
    ...
    $data = array(
        array(
            'date' => $currentDate,
            'dictionaryKey' => 'welcome-to-headless',
            'notes' => '',
            'idExecution' => uniqid(),
            'method' => 'POST',
            'username' => 'admin'
...
if (alreadyInstalled()) {
    $errorText = 'Headless.PHP is already installed.';
    error_log('[ERROR] ' . $errorText, 0);
    exit($errorText);
}
...
<head>
    <title><?php echo $L->get('Headless.PHP Installer') ?></title>
    ...
    <div class="container">
        <div class="row justify-content-md-center pt-5">
            <div class="col-md-4 pt-5">
                <h1 class="text-center mb-5 mt-5 font-weight-normal text-uppercase" style="color: #555;"><?php echo $L->get('Headless.PHP Installer') ?></h1>
                <?php
                $system = checkSystem();
                if (!empty($system)) {
